...
Implement thumbnail generation using `sharp` (256×256 WebP), integrate into the upload complete flow, serve via decryption pipeline, and display in file explorer.

### Acceptance Criteria

- [ ] Image thumbnails appear in file grid (not generic icons)
- [ ] Non-image files show generic icons without errors
- [ ] Thumbnails ≤ 256×256 px and ≤ 50KB
