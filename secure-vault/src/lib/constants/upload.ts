...
export const MAX_ACTIVE_UPLOADS_PER_USER = 3;
...
export const UPLOAD_ACTIVE_LEASE_TTL_SECONDS = 90;
export const UPLOAD_ACTIVE_RECORD_TTL_SECONDS = 180;
export const UPLOAD_ACTIVE_LOCK_TTL_SECONDS = 5;
