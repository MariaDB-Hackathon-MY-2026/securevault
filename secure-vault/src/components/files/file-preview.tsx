...
export type FilePreviewItem = Pick<FileListItem, "id" | "mimeType" | "name">;
...
function FilePreviewContent({ file }: { file: FilePreviewItem }) {
...
export function FilePreviewDialog({ file, onOpenChange, open }: FilePreviewDialogProps) {
  if (!file || !canPreviewMime(file.mimeType)) {
    return null;
  }
