...
export default async function HomePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(245,158,11,0.18),_transparent_30%),radial-gradient(circle_at_bottom_right,_rgba(15,23,42,0.10),_transparent_35%),linear-gradient(180deg,_rgba(255,255,255,1),_rgba(248,250,252,1))]">
      <div
        aria-hidden="true"
        className="absolute inset-0 opacity-40 [background-image:linear-gradient(to_right,rgba(15,23,42,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(15,23,42,0.05)_1px,transparent_1px)] [background-size:56px_56px] [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0.15))]"
      />

      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-4 py-4 sm:px-6 lg:px-8">
        <header className="border border-border/60 bg-background/90 backdrop-blur">
        ...
        <section className="grid flex-1 items-center gap-6 border-x border-b border-border/60 bg-background/70 px-4 py-10 backdrop-blur sm:px-6 sm:py-14 lg:grid-cols-[minmax(0,1.3fr)_minmax(320px,0.9fr)] lg:px-8 lg:py-18">
          <div className="max-w-3xl">
            <Badge variant="outline" className="rounded-none border-border/70 bg-background/85 px-3 py-1 text-[11px] uppercase tracking-[0.25em] text-muted-foreground shadow-sm">
            ...
            <div className="mt-8 flex flex-wrap gap-3 text-xs uppercase tracking-[0.2em] text-muted-foreground">
              <span className="border border-border/60 bg-background/80 px-3 py-2">Next.js 16</span>
              <span className="border border-border/60 bg-background/80 px-3 py-2">MariaDB + Redis</span>
              <span className="border border-border/60 bg-background/80 px-3 py-2">Cloudflare R2</span>
              <span className="border border-border/60 bg-background/80 px-3 py-2">Vitest + Playwright</span>
            </div>
          </div>

          <Card className="border-border/70 bg-background/88 shadow-xl shadow-slate-950/5 backdrop-blur">
            ...
            <CardContent className="grid gap-4 pt-6">
              {deliverySignals.map((signal) => (
                ...
                >
                  <div className="mt-0.5 border border-border/60 bg-primary/15 p-1.5 text-primary">
                    <Check className="size-4" />
                  </div>
                  <p className="text-sm leading-6 text-foreground">{signal}</p>
                </div>
              ))}
              <div className="border border-dashed border-border/70 bg-muted/40 p-4 text-sm text-muted-foreground">
        ...
        <section className="border-x border-b border-border/60 bg-background px-4 py-10 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-3 sm:max-w-2xl">
            <p className="text-xs uppercase tracking-[0.35em] text-muted-foreground">Core capabilities</p>
              ...
              return (
                ...
                >
                  <CardHeader className="gap-4">
                    <div className="flex size-10 items-center justify-center border border-border/60 bg-primary/12 text-primary">
        ...
        <section className="border-x border-b border-border/60 bg-muted/20 px-4 py-10 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-3 sm:max-w-2xl">
            <p className="text-xs uppercase tracking-[0.35em] text-muted-foreground">Operating model</p>
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-4">
            {operatingModel.map((item) => (
              <Card key={item.step} className="border-border/70 bg-background/90">
                <CardHeader>
                  <p className="text-xs uppercase tracking-[0.35em] text-muted-foreground">{item.step}</p>
        ...
        <section className="border-x border-b border-border/60 bg-background px-4 py-10 sm:px-6 lg:px-8">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)]">
            <Card className="border-border/70 bg-background/95">
              <CardHeader>
                <p className="text-xs uppercase tracking-[0.35em] text-muted-foreground">Why it matters</p>
              ...
              <CardContent className="grid gap-3 text-sm leading-6 text-muted-foreground">
                <div className="flex items-start gap-3 border border-border/60 bg-muted/25 p-4">
                  <FolderTree className="mt-0.5 size-4 text-primary" />
                  <p>
            ...
            <Card className="border-border/70 bg-primary text-primary-foreground">
              <CardHeader>
                <p className="text-xs uppercase tracking-[0.35em] text-primary-foreground/75">Get started</p>
              ...
              <CardContent className="grid gap-3 text-sm leading-6 text-primary-foreground/90">
