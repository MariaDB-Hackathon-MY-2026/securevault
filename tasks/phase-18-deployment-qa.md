...
- [ ] **18.4 - Manual pre-deployment checklist**
  ...
  - [ ] PDF under 10MB uploads, then indexes successfully without blocking the upload-ready state
  - [ ] PDF over 10MB uploads normally and shows semantic indexing skipped
  - [ ] Semantic search failure does not break upload, download, or preview flows
